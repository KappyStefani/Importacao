    ...
    internal class BDPedido
    {
        ...
        //Método Inlcuir
            public int Incluir(Pedido pobj_Pedido)
            {
                ...
                obj_Cmd.Parameters.AddWithValue("@S_DATA_PEDIDO", pobj_Pedido.Tot_Pedido);
        ...
        public Pedido FindByCodPedido(Pedido pobj_Pedido)
        {
            ...
            try
            {
                ...
                if (obj_Dtr.HasRows)
                {
                    ...
                    pobj_Pedido.Data_Pedido = Convert.ToString(obj_Dtr["S_DATA_PEDIDO"]);
            ...
            try
            {
                ...
                if (obj_Dtr.HasRows)
                {
                    while (obj_Dtr.Read())
                    {
                        ...
                        obj_Pedido.Data_Pedido = Convert.ToString(obj_Dtr["S_DATA_PEDIDO"]);
